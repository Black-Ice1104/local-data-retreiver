...
if __name__ == '__main__':
    ...
    prompt_template = """Answer the user's questions in a concise and professional manner based on the following known information.
    If the answer cannot be obtained, 
    please say "the question cannot be answered according to the known information" 
    or "not enough relevant information is provided". 
    It is not allowed to add fabrications in the answer, please use the answer in English.
    What is known:
    {context}
    Question:
    {question}"""
